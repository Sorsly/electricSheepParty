...
extern "C"  UnityWebRequest_t463507806 * UnityWebRequest_Put_m3541626144 (RuntimeObject * __this /* static, unused */, String_t* ___uri0, ByteU5BU5D_t4116647657* ___bodyData1, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
extern "C"  UnityWebRequest_t463507806 * UnityWebRequest_Post_m4211532029 (RuntimeObject * __this /* static, unused */, String_t* ___uri0, String_t* ___postData1, const RuntimeMethod* method)
{
	...
	}
	{
		...
		String_t* L_6 = WWWTranscoder_DataEncode_m692723224(NULL /*static, unused*/, L_4, L_5, /*hidden argument*/NULL);
		V_2 = L_6;
		Encoding_t1523322056 * L_7 = Encoding_get_UTF8_m1008486739(NULL /*static, unused*/, /*hidden argument*/NULL);
		String_t* L_8 = V_2;
		ByteU5BU5D_t4116647657* L_9 = VirtFuncInvoker1< ByteU5BU5D_t4116647657*, String_t* >::Invoke(10 /* System.Byte[] System.Text.Encoding::GetBytes(System.String) */, L_7, L_8);
		V_1 = L_9;
	}
...
IL_0034:
	{
		...
		UploadHandlerRaw_t25761545 * L_12 = (UploadHandlerRaw_t25761545 *)il2cpp_codegen_object_new(UploadHandlerRaw_t25761545_il2cpp_TypeInfo_var);
		UploadHandlerRaw__ctor_m1397254157(L_12, L_11, /*hidden argument*/NULL);
		UnityWebRequest_set_uploadHandler_m54574009(L_10, L_12, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_13 = V_0;
		UploadHandler_t2993558019 * L_14 = UnityWebRequest_get_uploadHandler_m3692520788(L_13, /*hidden argument*/NULL);
		UploadHandler_set_contentType_m2709466885(L_14, _stringLiteral3776665136, /*hidden argument*/NULL);
		UnityWebRequest_t463507806 * L_15 = V_0;
		DownloadHandlerBuffer_t2928496527 * L_16 = (DownloadHandlerBuffer_t2928496527 *)il2cpp_codegen_object_new(DownloadHandlerBuffer_t2928496527_il2cpp_TypeInfo_var);
		DownloadHandlerBuffer__ctor_m914761499(L_16, /*hidden argument*/NULL);
		UnityWebRequest_set_downloadHandler_m970510352(L_15, L_16, /*hidden argument*/NULL);
...
IL_001d:
	{
		...
		V_1 = L_5;
		bool L_6 = ___prependingProtocol2;
		if (L_6)
		{
			goto IL_008f;
		}
	...
	}
	{
		...
		Uri_t100236324 * L_21 = ___targetUri0;
		String_t* L_22 = Uri_get_PathAndQuery_m2396197970(L_21, /*hidden argument*/NULL);
		StringBuilder_Append_m1965104174(L_20, L_22, /*hidden argument*/NULL);
		StringBuilder_t * L_23 = V_2;
		Uri_t100236324 * L_24 = ___targetUri0;
		String_t* L_25 = Uri_get_Fragment_m575158891(L_24, /*hidden argument*/NULL);
...
IL_008f:
	{
		Uri_t100236324 * L_28 = ___targetUri0;
		String_t* L_29 = Uri_get_AbsoluteUri_m2582056986(L_28, /*hidden argument*/NULL);
		V_0 = L_29;
		goto IL_009b;
	}
